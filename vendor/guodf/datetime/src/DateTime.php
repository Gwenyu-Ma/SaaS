...
class DateTime implements \JsonSerializable
{
    ...
    */
    ...
    public function __toString()
    {
        ...
        . ' ' . $this->getDateTimePart('Hour') . ':' . $this->getDateTimePart('Minute') . ':' . $this->getDateTimePart('Second');
    }
    ...
    private function getDateTimePart($part)
    {
        switch ($part) {
            ...
            case 'Date':
                return $this->getDate();
            case 'Seconds':
                return intval($this->_dateTime/self::$Second);
            default:
