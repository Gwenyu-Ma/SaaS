define(function(require) {
                ...
                onLoadSuccess: function() {
                    ...
                    view.off('click', '.bootstrap-table').on('click', '.bootstrap-table', function(e) {
                        ...
                        if (id == 'btnDel') {
                            ...
                            if (checkArr.length) {
                                RsCore.ajax('message/delmsg', { did: checkArr.join(':') }, function(data, code, msg) {
                                    if (code == 0) {
                            ...
                            if (checkArr.length) {
                                RsCore.ajax('message/readmsg', { did: checkArr.join(':') }, function(data, code, msg) {
                                    if (code == 0) {
                                        $('button[name=refresh]').trigger('click');
                                    }
                                });
                            ...
                            RsCore.ajax('message/readmsg', { did: did }, function(data, code, msg) {
                                if (code == 0) {
                                    $('button[name=refresh]').trigger('click');
                                }
                            });
    ...
    return {
        ...
        render: function(container, paramStr) {
            document.title = '瑞星安全云-我的中心-我的信息';
