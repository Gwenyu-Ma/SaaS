define(function(require) {
    ...
    var op = {
        ...
        initEvent: function(container, paramStr) {
            ...
            view.on('click', '#btnCliDel', function() {
                ...
                if (params['c']) {
                    ...
                    bootbox.confirm('确定删除此终端', function(ok) {
                        if (ok) {
                            RsCore.ajax('ep/removeep', { 'sguids': ids }, function(date) {
            ...
            view.on('click', '#btnMoveTo', function() {
                ...
                view.find('#btnSaveMoveTo').data({ 'ids': ids, 'groupids': groupid, 'groupnames': groupName, 'clients': clients });
    ...
    return {
        ...
        destroy: function() {
            ...
            $(this.container).find('.client-view').slimscroll({ destroy: true });
