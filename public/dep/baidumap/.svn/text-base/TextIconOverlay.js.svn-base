...
(function() {
    ...
    TextIconOverlay.prototype.initialize = function(map) {
        ...
        this._domElement.className = 'BM_IconOverlay';
        this._updateCss();
        this._updateText();
    ...
    TextIconOverlay.prototype._updateText = function() {
        if (this._domElement) {
            this._domElement.innerHTML = '<div style="padding-top:8px;line-height:16px;font-size:12px;font-weight:normal;">人群</div><div style="line-height:16px;font-size:12px;font-weight:normal;">' + this._text + '</div>';
        }
    };
