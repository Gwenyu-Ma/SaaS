define(function(require) {
    var tpl = require('text!report/XAV_VirusStatistics.html');
    require('selectric');
    ...
    var op = {
        search: {
            ...
            init: function(view) {
                ...
                view.find('#btnSearch').on('click', function() {
                    ...
                    $('#tb-vStatistics').bootstrapTable('search');
                    //$('#tb-vStatistics').bootstrapTable('selectPage', 1);
        ...
        table: {
            init: function(view) {
                view.find('#tb-vStatistics').bootstrapTable({
                    url: 'public/test-data/XAV_VirusStatistics.json', //RsCore.ajaxPath+'m=home&c=Group&a=groupList',
                    method: 'get',
        ...
        chart: {
            ...
            init: function() {
                require(
                    ...
                    function(ec) {
                        var domLine = document.getElementById('chart-vStatistics');
                        if (!op.search.params) {
    ...
    return {
        ...
        destroy: function() {
            ...
            $(this.container).find('#tb-vStatistics').bootstrapTable('destroy');
