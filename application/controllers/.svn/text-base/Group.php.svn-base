...
class GroupController extends MyController
{
    ...
    public function editgroupAction()
    {
        ...
        if (empty($str_name) || mb_strlen($str_name) > 20) {
            Common::out(Common::returnAjaxMsg(1, 0, "组名称不符合要求"));
        }
    ...
    public function moveComputerAction()
    {
        ...
        if (is_array($result)) {
            Common::out(Common::returnAjaxMsg(2, 0, $result['msg']));
        }
    ...
    public function getGroupComputerAction()
    {
        ...
        if ($result) {
            ...
            Common::out(Common::returnAjaxMsg(1, 0, "", "数据不存在"));
        }
    ...
    public function getGroupAction()
    {
        ...
        if (!empty($id)) {
            ...
            if ($result) {
                ...
                Common::out(Common::returnAjaxMsg(1, 0, "操作异常。"));
            }
    ...
    public function getComputerinfoAction()
    {
        ...
        if (!empty($sguid)) {
            ...
            if ($result) {
                ...
                Common::out(Common::returnAjaxMsg(0, 0, "", "数据不存在"));
            }

        } else {
            Common::out(Common::returnAjaxMsg(1, 0, "参数不正确。"));
        }
    }
    ...
    public function groupListAction()
    {
        ...
        if ($result) {
            ...
            Common::out(Common::returnAjaxMsg(1, 0, "暂无分组"));
        }
    }
    ...
    public function autoAGroupAction()
    {
        ...
        if (!is_bool($ok)) {
            ...
            echo json_encode(Common::returnAjaxMsg(1, 0, $ok));
            return;
        }
        add_oplog('执行','AutoGroup\makeGroupAutoInGroup',null,null,null,'OK');
        OplogModel::add($_SESSION['UserInfo']['EID'], $_SESSION['UserInfo']['UserName'], '组', '更新', '重新自动入组');
        echo json_encode(Common::returnAjaxMsg(0, 0, '操作成功'));
    }
