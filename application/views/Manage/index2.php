...
<head>
    ...
    <script>
        ...
        hm.src = "https://hm.baidu.com/hm.js?f6545a9316453398c9bcb0c01e440423";
...
<body>
        ...
        <div class="rs-page-wrap">
            <div class="rs-page-wauto">
                <div class="rs-page-header">
                    <div class="aqy-tyb"><h1></h1><span>体验版</span></div>
                    <span class="rs-page-user">
                        <ul class="nav pull-right">
                            ...
                            <li class="bord" style="margin-left:-10px;">
                                <a href="{$pub}/view2/instruction.html" class="help-link" title="帮助" target="_blank">&nbsp;&nbsp;</a>
                            </li>
                        </ul>
                    </span>
                </div>
    ...
    <div class="page-load">
        ...
        <div><img src="{$img}/icon/loading_txt.png"></div>
    </div>
    ...
    <script src="{$pub}/dep/require/require.source.js" data-main="{$js}/main2"></script>
		...
		$(function(){
            ...
            RsCore.ajax('mycenter/myinfo', function(data) {
                if(data.company == "" || data.company == null){
                    ...
                    $(".rs-page-header h1").text(data.company + " ─ 安全云中心");
                }
            });
